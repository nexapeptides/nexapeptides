...
export default function NexaPeptidesPage() {
  ...
  const handleCheckout = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    alert(
      "Opening Gmail… If nothing happens, check your popup settings or make sure Gmail is your default email app."
    );
      ...
      <footer className="bg-neutral-950 text-neutral-300 mt-20">
        <div className="max-w-7xl mx-auto px-4 py-12 grid md:grid-cols-3 gap-8">
          ...
          <div className="text-sm text-neutral-400">
            © {new Date().getFullYear()} Nexa Peptides — For laboratory research
            only.
          </div>
        </div>
      </footer>
