  ...
  return (
    <main className="min-h-screen bg-white text-neutral-900 p-8 max-w-3xl mx-auto">
      ...
      <p className="text-sm text-neutral-700 mb-4">
        All products are sold strictly for laboratory research and in vitro
        investigation. Products are not approved for human or animal
      ...
      <p className="text-sm text-neutral-700 mb-4">
        Nothing on this site should be interpreted as medical advice. We do not
      ...
      <p className="text-sm text-neutral-700 mb-4">
        All sales are considered final once invoiced. Pricing and availability
