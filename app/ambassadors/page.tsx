...
Approved codes will provide 10% off for customers and 10% commission to the ambassador.
  ...
  if (submitted) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-neutral-100 text-center p-6">
  ...
  return (
    <main className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full bg-neutral-50 p-8 rounded-2xl shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            ...
            className="w-full border border-neutral-300 rounded-xl px-3 py-2 uppercase"
          />
          <button
            type="submit"
            className="w-full bg-black text-white py-2 rounded-xl font-semibold hover:opacity-90"
          >
            Submit Application
          </button>
        </form>
